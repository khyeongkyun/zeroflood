...
# from terratorch.models.backbones.terramind.utils import to_2tuple
from pangaea.encoders.terramind.utils import to_2tuple   # NOTE: Dependency update
...
class PipelineCond(DiffusionPipeline):
    ...
    def __call__(self, 
        ...
        image = torch.randn(
            (batch_size, self.n_channels, image_size[0], image_size[1]),
            generator=generator,
        )
