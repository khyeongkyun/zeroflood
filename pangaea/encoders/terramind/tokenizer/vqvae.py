...
from pangaea.encoders.terramind.utils import denormalize   # NOTE: Dependency update
...
class VQ(nn.Module, PyTorchModelHubMixin):
    ...
    Args:
        ...
        quant_type: String identifier specifying the quantizer implementation. Can be 'lucid', 'memcodes', or 'fsq'.
